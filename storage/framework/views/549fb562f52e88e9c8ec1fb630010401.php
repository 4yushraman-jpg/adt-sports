<?php $__env->startSection('title', ($settings['site_name'] ?? 'ADT Sports') . " — India's #1 Kabaddi Media"); ?>
    ...
    <a href="<?php echo e(route('article', $heroLead->slug)); ?>" class="hero-lead">
      <div class="hero-lead-art" style="background:<?php echo e($heroLead->cover_bg); ?>">
        <?php if($heroLead->cover_image): ?>
          <img src="<?php echo e($heroLead->cover_image); ?>" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover" alt="<?php echo e($heroLead->title); ?>">
        <?php else: ?>
      ...
      <div class="hero-lead-body">
        ...
        <?php endif; ?>
        <div class="hero-lead-title"><?php echo e($heroLead->title); ?></div>
      ...
      <a href="<?php echo e(route('article', $a->slug)); ?>" class="hero-stack-item">
        <div class="stack-thumb" style="background:<?php echo e($a->cover_bg); ?>">
          <?php if($a->cover_image): ?>
            <img src="<?php echo e($a->cover_image); ?>" style="width:100%;height:100%;object-fit:cover" alt="">
          <?php else: ?>
        ...
        <div>
          ...
          <div class="stack-title"><?php echo e($a->title); ?></div>
  ...
  <div class="content-grid">
    <main>
      ...
      <div class="feature-strip">
        ...
        <a href="<?php echo e(route('article', $a->slug)); ?>" class="fs-item" style="text-decoration:none">
          ...
          <div class="fs-title"><?php echo e($a->title); ?></div>
      ...
      <div class="cards-grid">
        ...
        <a href="<?php echo e(route('article', $a->slug)); ?>" class="card-box" style="text-decoration:none">
          ...
          <div class="cb-title"><?php echo e($a->title); ?></div>
    ...
    <aside class="sidebar-col">
      ...
      <div class="widget widget-nl" id="newsletter">
        ...
        <p class="nl-desc">Top Kabaddi stories, TSR stats & exclusives — free to your inbox.</p>
        <input type="email" class="nl-input" placeholder="your@email.com" id="nlEmail">
        <button class="nl-btn" onclick="subscribeNl()">Get The Digest →</button>
      </div>
      ...
      <div class="widget">
        ...
        <div class="socials-row">
          <?php if(!empty($settings['facebook_url'])): ?>  <a href="<?php echo e($settings['facebook_url']); ?>"  target="_blank" class="soc-btn">📘 Follow</a> <?php endif; ?>
          <?php if(!empty($settings['instagram_url'])): ?> <a href="<?php echo e($settings['instagram_url']); ?>" target="_blank" class="soc-btn">📸 Follow</a> <?php endif; ?>
          <?php if(!empty($settings['youtube_url'])): ?>   <a href="<?php echo e($settings['youtube_url']); ?>"   target="_blank" class="soc-btn">▶ Watch</a>  <?php endif; ?>
          <?php if(empty($settings['facebook_url']) && empty($settings['instagram_url']) && empty($settings['youtube_url'])): ?>
            <span class="soc-btn">📘 Follow</span>
            <span class="soc-btn">📸 Follow</span>
            <span class="soc-btn">▶ Watch</span>
          <?php endif; ?>
        </div>
      </div>
...
<?php echo $__env->make('layouts.frontend', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\adt-sports-laravel\resources\views/frontend/home.blade.php ENDPATH**/ ?>