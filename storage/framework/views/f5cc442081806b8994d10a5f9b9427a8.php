...
<div class="app-shell">
  ...
  <div class="main-row">
    <nav class="sidebar">
      ...
      <div style="margin-top:auto;padding:14px 10px;border-top:1px solid var(--border)">
        <div style="font-size:11px;color:var(--ink3);padding:4px 12px;line-height:1.7">
          ADT Sports v1.0<br>Laravel <?php echo e(app()->version()); ?><br>
...
<?php /**PATH C:\laragon\www\adt-sports-laravel\resources\views/layouts/admin.blade.php ENDPATH**/ ?>