...
<form action="<?php echo e($article ? route('admin.articles.update',$article) : route('admin.articles.store')); ?>"
  ...
  <div class="editor-grid">
    ...
    <div>
      ...
      <?php if($article): ?>
      <div class="panel-card" style="border-color:rgba(220,38,38,.2)">
        <h4 style="color:#FCA5A5">Danger Zone</h4>
        <form action="<?php echo e(route('admin.articles.destroy',$article)); ?>" method="POST"
          ...
          <button type="submit" class="btn btn-danger" style="width:100%">🗑️ Delete This Article</button>
        </form>
      </div>
      <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\adt-sports-laravel\resources\views/admin/articles/editor.blade.php ENDPATH**/ ?>